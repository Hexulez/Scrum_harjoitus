/*
Code is written by Henry juhola

Työn piti olla ryhmä projekti mutta se meni yksilö suorittamiseksi,
koska muilta ei sitä koodia tänne tullut ainuttakaan riviä
*/
...
const apple = () => {
  ...
  if (snake[0].x == fruit.x && snake[0].y == fruit.y){ //jos käärmeen pää osuu hedelmään niin saa pisteet ja tulee uusi.
    score += 10;
    getApple = true;
    fruit.y =randomFood() //nä mä ottaa toiselta funtiolta satunnaisen arvon sijainniksi.
    fruit.x = randomFood()
